# impact-graph-canvas Specification

## Purpose

Defines the center Canvas Surface of the Impact & Change Workspace mock-up: the impact graph's dataset, node/edge typing, navigation controls, selection/hover interaction, and the scripted highlight/overlay behaviors driven by object selection and the "Preview impact" action.
