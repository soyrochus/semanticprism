...
Defines the overall shell of the Impact & Change Workspace mock-up: the four-zone layout, the top bar's contents, light/dark theming with semantic accent colors, and presentation mode.
